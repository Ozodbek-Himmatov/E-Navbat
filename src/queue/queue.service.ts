...
import { CreateExampleDto } from './dto/create-queue.dto';
import { UpdateExampleDto } from './dto/update-queue.dto';
import { Example, ExampleDocument } from './schemas/queue.schema';
